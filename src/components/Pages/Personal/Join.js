...
const Join = ({IsFooterLoaded}) => {
    IsFooterLoaded()
    return ( 
        <section className="JoinSection">
            <article className="Join_LogoSection">
                <Link to='/'>
            ...
            <article className='JoinLinkWrap'>
                ...
                <div className='FESTSURI_Join'>
                    ...
                    <div className='FESTSURI_TextWrap'>회원가입</div>
                </div>
            </article>
        </section>
    );
